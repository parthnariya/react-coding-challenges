  ...
  return (
    <div  className={darkMode?"app dark-mode" :"app"}  >
      <div className="level">
        ...
        <button className="app__dark-mode-btn icon level-right" onClick={darkModeHandler}>
          {!darkMode ? <FontAwesomeIcon icon={faMoon} /> : <FontAwesomeIcon icon={faSun} color="#FFA500"/>}
        </button>
